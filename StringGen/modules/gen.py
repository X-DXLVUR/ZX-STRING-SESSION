...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@Soul_x6"))
        else:
            ...
            await client.join_chat("Soul_x6")
    except KeyError:
        pass
    try:
...
async def cancelled(message):
    if "/cancel" in message.text:
        ...
        await message.reply_text(
            "» sᴜᴄᴄᴇssғᴜʟʟʏ ʀᴇsᴛᴀʀᴛᴇᴅ ᴢx sᴛʀɪɴɢ ʙᴏᴛ.", reply_markup=retry_key
        )
        return True
